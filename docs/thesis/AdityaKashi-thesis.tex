% TODO
% TRY to get flap rotation case with DGRBF
% FOR hybrid DGM, an illustrative diagram would be good
% TRY to get flap rotation case with RBF single step
...
\thesistitle{Techniques for Mesh Movement and Curved Mesh Generation \\for Computational Fluid Dynamics}
...
\graphicspath{{images/}{Chapter-2/figs/}{Chapter-3/figs/}{Chapter-4/figs/}}
