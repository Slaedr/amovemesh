...
// June 2, 2015: Adding refine mesh function, and otherwise modified (by adding variable naux etc) to help generate quadratic meshes
...
public:
	...
	UTriMesh_c() {alloc_jacobians = false;}
	/* UTriMesh()
	{
	...
	UTriMesh_c& operator=(UTriMesh_c& other)
	{
		npoin = other.npoin;
		nelem = other.nelem;
		nface = other.nface;
