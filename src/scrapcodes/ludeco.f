c
c====================================================================
c...  Unit of subs for direct solver (Dr. Hong Luo)
c====================================================================
c
c>      LU decomposition stocked in 1D profile
        subroutine lupoin(npoin, npoi1 ,nstor, upper, lower, ldiag )
c
c>          Aditya : ldiag is an array of size (number of rows)+1. ldiag(1) = 0, 
c>              and ldiag(i+1) = ldiag(i) + bandwidth(row i)
c>              npoin is the number of rows (and the number of columns)
c>              in the matrix.
c>              I would guess nstor = nnz
c
...
c>      LU solution stocked in 1D profile
        subroutine repoin(npoin, npoi1, nstor, upper, lower, ldiag ,rhs)
c
            implicit real*8 (a-h,o-z)
c
            integer    ldiag(npoi1)
