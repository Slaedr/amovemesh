...
Matrix<double> gausselim(Matrix<double>& A, Matrix<double>& b, double tol=1e-10)
{
...
Matrix<double> gaussseidel_ng(double (*A)(int,int), double (*b)(int), int arows, int acols, int brows, Matrix<double> xold, double tol, int maxiter, char check)
{
